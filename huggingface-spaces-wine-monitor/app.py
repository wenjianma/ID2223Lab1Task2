...
dataset_api.download("Resources/images/actual_wine.jpg", overwrite=True)
...
with gr.Blocks() as demo:
    with gr.Row():
        ...
        with gr.Column():
            ...
            input_img = gr.Image("actual_wine.jpg", elem_id="actual-img")
    with gr.Row():
        with gr.Column():
        ...
        with gr.Column():
            ...
            input_img = gr.Image("confusion_matrix.png",
